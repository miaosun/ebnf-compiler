...
class SimpleNode implements Node {
  ...
  //for dotty
	...
	private static ArrayList<String> dottyIdentifiers = new ArrayList<String>();
	private static ArrayList<String> dottyStartEnd = new ArrayList<String>();
	private static ArrayList<String> dottyRepetition = new ArrayList<String>();
  ...
  public void printNode(Writer writer) throws IOException {
    ...
    switch(this.id)
    {
      ...
      case EbnfTreeConstants.JJTSPECIALSEQ :
        ...
        break;
      default :   
        System.out.println("Ṇo processado: "+EbnfTreeConstants.jjtNodeName[this.id]);
        break;
    }
  ...
  private void printLabelsDotty(Writer dwriter) throws IOException {
		...
		//print ident e startEnd
		for(String se : dottyStartEnd)
			dwriter.write(se+" [shape=Mdiamond];\n");
		for(String i : dottyIdentifiers)
			dwriter.write(i+" [shape=box];\n");
		for(String r : dottyRepetition)
			dwriter.write(r+" [shape=hexagon];\n");
	}
	...
	public void printRulesDotty(Writer dwriter) throws IOException {
		...
		for(int i=0; i<children.length; i++)
		{
			resetLabelsMap();
			dottyStartEnd.clear();
			dottyIdentifiers.clear();
			dottyRepetition.clear();
	...
	public void printRuleDotty(Writer dwriter) throws IOException {
		...
		dottyStartEnd.add(initialNode);
		inNodes.add(initialNode);

		String endNode = addLabel("End");
		dottyStartEnd.add(endNode);
	...
	private ArrayList<String> printRepetition(ArrayList<String> inNodes, Writer dwriter) throws IOException {
		...
		dottyRepetition.add(initRepetition);
	...
	private ArrayList<String> printTerminal(ArrayList<String> inNodes, Writer dwriter) throws IOException {
		ArrayList<String> res = new ArrayList<String>();
		String value = addLabel(""+jjtGetValue());
		if(id==EbnfTreeConstants.JJTIDENTIFIER)
			dottyIdentifiers.add(value);
		res.add(value);
